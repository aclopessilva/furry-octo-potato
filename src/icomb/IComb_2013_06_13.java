...
// * 
// * iComb is am iMath project to provides a tool to teach/learn counting:
// *  teacher: can create new exercises (authoring)
// *  student: can solve the exercise, with an integrated Inteligent Tutoring System
// * 
// * iComb exercise model is based in a decomposition of the problem, following
// * the "Conbien?" scheme.
// * 
...
///**
// * @author 
// * Alexandre Eisenmann<br>
// * 30/04/2008
// */
//
///**
// * Esta é classe principal do programa e está implementada na forma
// * <b>superapplet</b>, ou seja, funciona tanto como applet quanto
...
//    System.out.println(" .: iComb : Combinatória Interativa na Internet ("+versao+") :.\n    http://www.matematica.br/icomb");
//
//    try {
//
...
//          ObjectManager.setMachine.setExercicio(ex);
//          ObjectManager.setMachine.setArquivoUniverso(ArquivoUniverso);
