 ...
 * 
 * @author AEK, LOB
 * @description PopUp with information about buttons or choice
 * @see ObjectManager.java: launches ToolTip
 * 
 */
...
public class ToolTip extends Canvas {
  ...
  private static final Color BACK_COLOR = new Color(255,255,220), LINE_COLOR = new Color(100,100,100);
